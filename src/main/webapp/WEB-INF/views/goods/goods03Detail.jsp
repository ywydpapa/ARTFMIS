			...
			<hr>
				<form name="form1" id="form1" onSubmit="return false;">
					<table class="table  table-bordered nowrap">
						...
						<tbody>
							<tr>
								<td style="vertical-align:middle;text-align:center;background-color:#E6F8E0" scope="col" width="200"><input type="hidden"
							...
							<tr>
								...
								<td style="vertical-align:middle;text-align:center;background-color:#E6F8E0">주문프로그램표시 여부</td>
								<td style="vertical-align:middle"><select class="form-control form-control-sm"
							...
							<tr>
								...
								<td style="vertical-align:middle"><input type="number" class="form-control"
									style="text-align: right;" step="1" min = "0" name="GOODS_ORDER" id="GOODS_ORDER"
								...
								<td style="vertical-align:middle;text-align:center;background-color:#E6F8E0">냉장고품목</td>
								<td style="vertical-align:middle"><select class="form-control form-control-sm"
									id="GOODS_REFG_YN"  required>
										<option value="Y">예</option>
										<option value="N">아니오</option>
								</select></td>
...
function numberWitioutCommas(x) {
	...
	function fn_goodsUpdate01() {
		...
		.done(function(data) {
			if (data.code == 10001) {
				alert("저장 성공");
				var url = "${path}/goods/listGoods03/" + $("#selcode02").val();
				fn_Reload03(url);
