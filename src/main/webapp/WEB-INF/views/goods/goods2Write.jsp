	...
	<div class="row" align="center">
		<div class="col-lg-12">
			<div class="card_box sch_it">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3"><input type="text" class="form-control" required
									name="GOODS_TITLE" id="GOODS_TITLE" placeholder="품목을 입력해 주세요" /></td>
							</tr>
							<tr>
								<td>규격</td>
								<td colspan="3"><input type="text" class="form-control" required
									name="GOODS_SPEC" id="GOODS_SPEC" placeholder="규격을 입력해 주세요" /></td>
							</tr>
							<tr>
								<td>재질</td>
							...
							<tr>
								...
								<td><input type="number" class="form-control" style = "text-align:right;" required
									name="GOODS_SALE_UNIT" id="GOODS_SALE_UNIT" /></td>
								<td>단위수량단위</td>
								<td><input type="text" class="form-control" required
									name="GOODS_UNIT_QTY" id="GOODS_UNIT_QTY" /></td>
							</tr>
							<tr>
								<td>개당가격</td>
								<td><input type="number" class="form-control" style = "text-align:right;" required
									name="GOODS_NET_PRICE" id="GOODS_NET_PRICE" /></td>
								<td>기본수량</td>
								<td><input type="text" class="form-control" required
									name="GOODS_INT_QTY" id="GOODS_INT_QTY" /></td>
							</tr>
							<tr>
								<td>판매단위</td>
								<td><input type="text" class="form-control" required
									name="GOODS_UNIT" id="GOODS_UNIT" /></td>
 								<td>판매금액</td>
								<td><input type="number" class="form-control" style = "text-align:right;" required
									name="GOODS_SALE_PRICE" id="GOODS_SALE_PRICE" /></td>
							</tr>
							<tr>
								<td>전통/현대식</td>
							...
							<tr>
								...
								<td><select class="form-control form-control-sm"
									id="GOODS_RETURN_YN" name="GOODS_RETURN_YN">
										<option value="1">반품가능</option>
										<option value="2">반품불가</option>
								</select></td>
								<td>냉장고품목유무</td>
								<td><select class="form-control form-control-sm"
									id="GOODS_REFG_YN" name="GOODS_REFG_YN">
										<option value="REGY">예</option>
										<option value="REGN">아니오</option>
								</select></td>
							</tr>
							<tr>
								<td>초도주문 여부</td>
							...
							<tr>
								...
								<td><input type="number" class="form-control" style="text-align:right;"
									name="GOODS_ORDER" id="GOODS_ORDER" value="10" /></td>
								<td>사용유무</td>
							...
							<tr>
								...
								<td colspan="3"><textarea id="GOODS_REMARK" required
										name="GOODS_REMARK" rows="4" class="form-control"></textarea></td>
							</tr>
						</tbody>
					</table>
				</form>
				...
				<button class="btn btn-md btn-primary" onClick="fn_goodsInsert()">저장</button>
				<button class="btn btn-md btn-inverse" onClick="javascript:fnSetPage('${path}/goods/goods2list.do')">목록</button>
				</div>
		</div>
	</div>
</div>
...
<script>
	function fn_goodsInsert() {
		...
		.done(function(data) {
			if (data.code == 10001) {
				alert("저장 성공");
				fnSetPage('${path}/goods/goodsList.do');
			} else {
				alert("저장 실패");
			}
