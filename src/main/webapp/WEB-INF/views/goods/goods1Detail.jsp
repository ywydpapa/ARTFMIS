					...
					<table class="table  table-bordered nowrap">
						<tbody>
							<tr>
								...
								<button class="btn btn-md btn-success" value="추가" id="btn-add-row">새항목 추가</button>
								</td>
							</tr>
							<tr>
								<td>품명</td>
							...
							<tr>
								...
								<td><input type="text" class="form-control" required
									...
									<tr>
 								<td>판매금액</td>
								<td colspan="3"><input type="number" class="form-control" style = "text-align:right;" required
...
<script>
	function fn_goodsUpdate() {
		...
		.done(function(data) {
			if (data.code == 10001) {
				alert("저장 성공");
				fnSetPage('${path}/goods/goods1list.do');
			} else {
				alert("저장 실패");
			}
