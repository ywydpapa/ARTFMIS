...
<div>
  ...
  <tbody>
    ...
    <c:forEach var="row" items="${listgoods03}">
    <tr>
      <td style="vertical-align:middle;text-align:center" class="first">매점용품</td>
      <td style="vertical-align:middle;text-align:center" class="first">${row.CAT_02_TITLE}</td>
      <td style="vertical-align:middle"><a href="javascript:fn_Reload04('${path}/goods/detail03/${row.GOODS_ID}')">${row.GOODS_TITLE}</a></td>
