					...
					<table class="table  table-bordered nowrap">
						...
						<tbody>	
							...
							<tr>
								...
								<th style="text-align:center;" scope="row"><input class="form-control CHK" type="checkbox" id="checkbox0" <c:if test="${row.STORE_GOODS_INIT_QTY ne null }">checked</c:if>></th>
							</tr>
							</c:forEach>
