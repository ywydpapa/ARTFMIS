...
<div>
  ...
  <tbody>
    ...
    <c:forEach var="row" items="${listgoods02}">
    <tr>
      <td style="vertical-align:middle;text-align:center" class="first">식당용품</td>
      <td style="vertical-align:middle;text-align:center" class="first">${row.CAT_02_TITLE}</td>
      <td style="vertical-align:middle"><a href="javascript:fn_Reload04('${path}/goods/detail02/${row.GOODS_ID}')">${row.GOODS_TITLE}</a></td>
