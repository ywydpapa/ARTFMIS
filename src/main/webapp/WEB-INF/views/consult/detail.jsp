							...
							<div class="col-sm-12">
										...
										<table class="table table-sm bst02">
											...
											<tbody>
												...
												<tr align="center">
													...
													<td>행사업체</td>
													<td><input class="form-control" id="contp1-04" value = ""></td>
													<td></td>													
												</tr>
												<tr align="center">
													<th rowspan="5">환자명</th>
													...
													<td><input type="text" 
														...
														name="contp1-07" value="${detailCont.SANGJU_NAME}">
													</td>
													<td>주민등록번호</td>
													<td><input type="text" size="13" maxlength="15"
														class="form-control form-control-sm" id="contp1-08"
												...
												<tr align="center">
													...
													<td colspan="2"><input type="text"
														...
														name="contp1-10" value="" placeholder="주소를 입력해 주십시오.">
													</td>
													<td>본관</td>
													<td><input type="text"
												...
												<tr align="center">
													...
													<td colspan="2"><input type="text"
														...
														name="contp1-12" value="" placeholder="상세주소를 입력해 주십시오.">
													</td>
													<td>종교</td>
												...
												<tr align="center">
													...
													<td><input type="text"
														...
														name="contp1-17" value="" placeholder="사망장소를 입력해 주십시오.">
													</td>
													<td>지역</td>
													<td><input type="text"
												...
												<tr align="center">
													...
													<td><input type="text"
														...
														name="contp1-20" value="" placeholder="상주의 성명을 입력해 주십시오.">
													</td>
													<td>주민등록번호</td>
													<td><input type="text"
														class="form-control form-control-sm" id="contp1-21"
														name="contp1-21" value=""></td>
													<td>관계</td>
												...
												<tr align="center">
													...
													<td colspan="2"><input type="text"
														...
														name="contp1-23" value="" placeholder="주소를 입력해 주십시오.">
													</td>
													<td>연락처</td>
													<td><input type="text"
														class="form-control form-control-sm" id="contp1-24"
														name="contp1-24" value=""></td>
												</tr>
												<tr align="center">
													<td>상세주소</td>
													<td colspan="2"><input type="text"
														class="form-control form-control-sm" id="contp1-25"
														name="contp1-25" value="" placeholder="상세주소를 입력해 주십시오.">
													</td>
													<td></td>
													<td></td>
												</tr>
												...
												<tr align="center">
													...
													<td colspan="3"><input type="text"
														...
														name="contp1-30" value="" placeholder="장지 입력해 주십시오.">
													</td>
													<td></td>
													<td></td>
												</tr>
								...
								<div class="btn_wr text-right mt-3">
									<button class="btn btn-md btn-primary"
										onClick="fn_contInsertP1()">등록</button>
								</div>
							</div>
						</div>
					</div>
