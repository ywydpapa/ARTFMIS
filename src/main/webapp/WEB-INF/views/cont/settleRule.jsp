			...
			<div class="card-block table-border-style">
				...
				<div class="table-responsive">
					<table id = "DOS01" class="table  table-bordered nowrap">
						...
						<tbody>	
							<c:forEach var="row" items="${setlistroom}">
							<tr style="text-align:center;">
								<td>${row.FROOM_TITLE}<input type="hidden" class="FID" value="${row.FROOM_ID}"/></td>
								<td></td>
								<td>
								<select name="SETLTYP" id="SETLTYP"
									class="form-control form-control-sm STYP">
								...
								<select name="USEYN" id="USEYN"
									class="form-control form-control-sm UYN">
