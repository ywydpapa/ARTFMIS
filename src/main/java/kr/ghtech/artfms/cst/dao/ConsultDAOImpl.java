...
public class ConsultDAOImpl implements ConsultDAO {
	...
	public List<ConsultDTO> consultModalSearch(ConsultDTO dto) {
		// TODO Auto-generated method stub
		return sqlSession.selectList("consult.consultModalSearch", dto);
	}

	@Override
	public List<ConsultDTO> writeConsultSelect(Integer CONSULT_ID) {
		// TODO Auto-generated method stub
		return sqlSession.selectList("consult.writeConsultSelect", CONSULT_ID);
	}

	@Override
	public List<ConsultDTO> getConsultId() {
		// TODO Auto-generated method stub
		return sqlSession.selectList("consult.getConsultId");
	}
